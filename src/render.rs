...
pub struct CanvasRenderer<'a, T: RenderTarget> {
    canvas: &'a mut Canvas<T>,
}

impl<'a, T: RenderTarget> CanvasRenderer<'a, T>
{
    ...
    {
        self.canvas.draw_point(sdl2::rect::Point::new((point.position[0] * 800.0) as i32, (point.position[1] * 600.0) as i32)).unwrap();
    }
}